clear
tic
dataframe = 'dataframe_0.25-30Hz_500ms.mat'; % 'dataframe_interp1.mat'
%dataframe = 'dataframe_interp0.mat';
load(dataframe)
toc
%% parameters:
...
% n1RElow = min(RElow(:,48:75)');
% n1REhigh = min(REhigh(:,48:75)');
% n1erlow = min(erlow(:,48:75)');
% n1erhigh = min(erhigh(:,48:75)');
% 
% IDgoodRElow = RElow < 50;
% plot(mean(RElow(IDgoodRElow,:)',2));hold on; plot(mean(RElow,1))
